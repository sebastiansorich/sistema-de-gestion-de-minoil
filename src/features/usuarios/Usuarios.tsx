    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-4 bg-white p-3 rounded-lg border">
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            placeholder="Buscar usuarios por nombre, usuario, email, sede, área o cargo..."
            value={searchTerm}
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        <div className="flex items-center gap-1 mb-1">
                          ...
                          <span className="font-medium">{usuario.sede.nombre}</span>
                        </div>
                        <div className="flex items-center gap-1 mb-1">
                          <MapPin className="w-3 h-3 text-gray-400" />
                          <span className="text-gray-600">{usuario.area.nombre}</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <Briefcase className="w-3 h-3 text-gray-400" />
                          <span className="text-gray-600">{usuario.cargo.nombre}</span>
